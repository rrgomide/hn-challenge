...
const radioItemVariants = cva(
  'relative flex items-center justify-center gap-2 px-3 py-2 rounded-md font-medium transition-all duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-transparent',
  {
    variants: {
      ...
      variant: {
        default:
          'data-[checked]:bg-background data-[checked]:text-foreground data-[checked]:border-primary data-[checked]:shadow-sm data-[checked]:shadow-primary/20 hover:bg-background/50 hover:border-border text-muted-foreground',
        filled:
          'data-[checked]:bg-primary data-[checked]:text-primary-foreground data-[checked]:border-primary data-[checked]:shadow-sm data-[checked]:shadow-primary/20 hover:bg-muted hover:border-border text-muted-foreground',
      },
    },
    defaultVariants: {
      size: 'default',
  ...
  ({ className, size, variant, value, disabled, children, ...props }, ref) => {
    ...
    return (
      <label
        ref={ref}
        className={cn(
          radioItemVariants({ size, variant, className }),
          className
        )}
